...
const CATALOG_ENTRIES = [
  ...
  { module: 'core', router: 'sources', action: 'cleanup_orphans', label: 'Clean Up Orphan Sources', description: 'Hard-delete orphaned polymorphic sources rows in the caller tenant schema', sort_order: 154 },
  ...
  { module: 'tenants', router: 'orphan_portal_users', action: 'find_orphans', label: 'Preview Orphan Portal Users', description: 'List portal_users rows with no portal_user_tenants binding (active or archived)', sort_order: 1126 },
  { module: 'tenants', router: 'orphan_portal_users', action: 'cleanup_orphans', label: 'Clean Up Orphan Portal Users', description: 'Hard-delete a single orphan portal_user', sort_order: 1127 },
