...
const CATALOG_ENTRIES = [
  ...
  { module: 'core', router: 'sources', action: 'find_orphans', label: 'Preview Orphan Sources', description: 'List polymorphic sources rows whose owning entity has been hard-deleted', sort_order: 153, policy_required: false },
  { module: 'core', router: 'sources', action: 'cleanup_orphans', label: 'Clean Up Orphan Sources', description: 'Hard-delete orphaned polymorphic sources rows in the caller tenant schema', sort_order: 154, policy_required: false },
  ...
  { module: 'tenants', router: 'orphan_portal_users', action: null, label: 'Orphan Portal Users', description: 'Maintenance for portal_users with no active tenant bindings (Axerra only)', sort_order: 1125, policy_required: false },
  { module: 'tenants', router: 'orphan_portal_users', action: 'find_orphans', label: 'Preview Orphan Portal Users', description: 'List portal_users rows with no active portal_user_tenants binding', sort_order: 1126, policy_required: false },
  { module: 'tenants', router: 'orphan_portal_users', action: 'cleanup_orphans', label: 'Clean Up Orphan Portal Users', description: 'Hard-delete a single orphan portal_user', sort_order: 1127, policy_required: false },
