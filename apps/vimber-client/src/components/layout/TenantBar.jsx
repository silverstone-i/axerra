 ...
 * @module vimber-client/components/layout/TenantBar
 *
...
export default function TenantBar() {
  ...
  return (
    <AppBar position="sticky" sx={{ ...tenantBarSx, zIndex: (t) => t.zIndex.appBar }}>
      <Toolbar variant="dense" sx={{ px: 2, justifyContent: 'space-between' }}>
        ...
        <Box sx={{ display: 'flex', alignItems: 'center', gap: 1 }}>
          ...
          <Avatar variant="header" onClick={handleMenuOpen} sx={{ cursor: 'pointer' }}>
            {userInitials(user)}
          </Avatar>
        </Box>
