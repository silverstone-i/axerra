/**
 * @file Tax identifier API methods — CRUD for tax identifiers linked via sources
 * @module vimber-client/services/taxIdentifierApi
 *
 * Base path: /core/v1/tax-identifiers
 *
...
const BASE = '/core/v1/tax-identifiers';
...
export default taxIdentifierApi;
