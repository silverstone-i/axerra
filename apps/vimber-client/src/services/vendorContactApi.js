/**
 * @file Vendor Contact API methods — CRUD for vendor contact people
 * @module vimber-client/services/vendorContactApi
 *
 * Base path: /core/v1/vendor-contacts
 *
...
const BASE = '/core/v1/vendor-contacts';
...
export default vendorContactApi;
