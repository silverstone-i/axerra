 ...
 * @module vimber-client/services/reportApi
 *
...
export const reportApi = {
  ...
  profitabilityByProject: (projectId) => client.get(`/reports/v1/project-profitability/${projectId}`),

  /** GET /project-cashflow/:projectId — monthly cashflow for a project. */
  cashflowByProject: (projectId) => client.get(`/reports/v1/project-cashflow/${projectId}`),

  /** GET /project-cashflow/:projectId/forecast — expected inflows/outflows + burn rate. */
  cashflowForecast: (projectId) => client.get(`/reports/v1/project-cashflow/${projectId}/forecast`),

  /** GET /project-cost-breakdown/:projectId — category-level cost breakdown. */
  costBreakdownByProject: (projectId) => client.get(`/reports/v1/project-cost-breakdown/${projectId}`),
  ...
  arAgingByClient: (clientId) => client.get(`/reports/v1/ar-aging/${clientId}`),
  ...
  apAgingByVendor: (vendorId) => client.get(`/reports/v1/ap-aging/${vendorId}`),
  ...
  marginAnalysis: (params = {}) => client.get(`/reports/v1/margin-analysis${qs(params)}`),
};
