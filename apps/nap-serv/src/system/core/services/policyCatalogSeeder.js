...
const CATALOG_ENTRIES = [
  ...
  { module: 'core', router: 'companies', action: null, label: 'Companies', description: 'Company entities for intercompany accounting', sort_order: 180, available_fields: ['code', 'name', 'is_active'] },
  { module: 'core', router: 'companies', action: 'import', label: 'Import Companies', description: 'Import company records from spreadsheet', sort_order: 181, policy_required: false },
  { module: 'core', router: 'companies', action: 'export', label: 'Export Companies', description: 'Export company records to spreadsheet', sort_order: 182, policy_required: false },
