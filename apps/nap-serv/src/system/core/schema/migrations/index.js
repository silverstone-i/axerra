...
import emailsAndVendorContacts from './202603180014_emailsAndVendorContacts.js';
export default [coreRbac, coreEntities, numberingSystem, importExportCatalog, emailsAndVendorContacts];
