 ...
 * @module client/config/navigationConfig
 *
...
export const NAV_ITEMS = [
  ...
  },
  {
    ...
    children: [
      ...
      { label: 'Platform Maintenance', path: '/tenant/platform-maintenance', capability: 'tenants::orphan_portal_users::find_orphans', hideWhileImpersonating: true },
    ],
  },
];
