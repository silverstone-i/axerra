...
export const COUNTRIES = [
  { code: 'AD', name: 'Andorra', dial_code: '+376', placeholder: 'XXX XXX' },
  { code: 'AE', name: 'United Arab Emirates', dial_code: '+971', placeholder: 'XX XXX XXXX' },
  ...
  { code: 'AR', name: 'Argentina', dial_code: '+54', placeholder: 'XX XXXX-XXXX' },
  { code: 'AS', name: 'American Samoa', dial_code: '+1' },
  { code: 'AT', name: 'Austria', dial_code: '+43', placeholder: 'XXXX XXXXXX' },
  { code: 'AU', name: 'Australia', dial_code: '+61', placeholder: 'XXXX XXX XXX' },
  ...
  { code: 'BE', name: 'Belgium', dial_code: '+32', placeholder: 'XXX XX XX XX' },
  ...
  { code: 'BR', name: 'Brazil', dial_code: '+55', placeholder: '(XX) XXXXX-XXXX' },
  ...
  { code: 'CA', name: 'Canada', dial_code: '+1', placeholder: '(XXX) XXX-XXXX' },
  ...
  { code: 'CH', name: 'Switzerland', dial_code: '+41', placeholder: 'XX XXX XX XX' },
  { code: 'CI', name: 'Cote d Ivoire', dial_code: '+225' },
  { code: 'CK', name: 'Cook Islands', dial_code: '+682' },
  { code: 'CL', name: 'Chile', dial_code: '+56', placeholder: 'X XXXX XXXX' },
  { code: 'CM', name: 'Cameroon', dial_code: '+237' },
  { code: 'CN', name: 'China', dial_code: '+86', placeholder: 'XXX XXXX XXXX' },
  { code: 'CO', name: 'Colombia', dial_code: '+57', placeholder: 'XXX XXX XXXX' },
  ...
  { code: 'CZ', name: 'Czechia', dial_code: '+420', placeholder: 'XXX XXX XXX' },
  { code: 'DE', name: 'Germany', dial_code: '+49', placeholder: 'XXXX XXXXXXX' },
  { code: 'DJ', name: 'Djibouti', dial_code: '+253' },
  { code: 'DK', name: 'Denmark', dial_code: '+45', placeholder: 'XX XX XX XX' },
  { code: 'DM', name: 'Dominica', dial_code: '+1' },
  { code: 'DO', name: 'Dominican Republic', dial_code: '+1', placeholder: '(XXX) XXX-XXXX' },
  { code: 'DZ', name: 'Algeria', dial_code: '+213' },
  { code: 'EC', name: 'Ecuador', dial_code: '+593' },
  { code: 'EE', name: 'Estonia', dial_code: '+372' },
  { code: 'EG', name: 'Egypt', dial_code: '+20', placeholder: 'XX XXXX XXXX' },
  { code: 'EH', name: 'Western Sahara', dial_code: '+212' },
  { code: 'ER', name: 'Eritrea', dial_code: '+291' },
  { code: 'ES', name: 'Spain', dial_code: '+34', placeholder: 'XXX XX XX XX' },
  { code: 'ET', name: 'Ethiopia', dial_code: '+251' },
  { code: 'FI', name: 'Finland', dial_code: '+358', placeholder: 'XX XXX XXXX' },
  ...
  { code: 'FR', name: 'France', dial_code: '+33', placeholder: 'X XX XX XX XX' },
  { code: 'GA', name: 'Gabon', dial_code: '+241' },
  { code: 'GB', name: 'United Kingdom', dial_code: '+44', placeholder: 'XXXX XXX XXXX' },
  ...
  { code: 'GR', name: 'Greece', dial_code: '+30', placeholder: 'XXX XXX XXXX' },
  { code: 'GS', name: 'South Georgia and South Sandwich Islands', dial_code: '+500' },
  ...
  { code: 'HK', name: 'Hong Kong', dial_code: '+852', placeholder: 'XXXX XXXX' },
  { code: 'HM', name: 'Heard Island and McDonald Islands', dial_code: '+672' },
  { code: 'HN', name: 'Honduras', dial_code: '+504' },
  { code: 'HR', name: 'Croatia', dial_code: '+385' },
  { code: 'HT', name: 'Haiti', dial_code: '+509' },
  { code: 'HU', name: 'Hungary', dial_code: '+36', placeholder: 'XX XXX XXXX' },
  { code: 'ID', name: 'Indonesia', dial_code: '+62', placeholder: 'XXX-XXXX-XXXX' },
  { code: 'IE', name: 'Ireland', dial_code: '+353', placeholder: 'XX XXX XXXX' },
  { code: 'IL', name: 'Israel', dial_code: '+972', placeholder: 'XX-XXX-XXXX' },
  { code: 'IM', name: 'Isle of Man', dial_code: '+44' },
  { code: 'IN', name: 'India', dial_code: '+91', placeholder: 'XXXXX XXXXX' },
  ...
  { code: 'IT', name: 'Italy', dial_code: '+39', placeholder: 'XXX XXX XXXX' },
  { code: 'JE', name: 'Jersey', dial_code: '+44' },
  { code: 'JM', name: 'Jamaica', dial_code: '+1' },
  { code: 'JO', name: 'Jordan', dial_code: '+962' },
  { code: 'JP', name: 'Japan', dial_code: '+81', placeholder: 'XX-XXXX-XXXX' },
  ...
  { code: 'MX', name: 'Mexico', dial_code: '+52', placeholder: 'XX XXXX XXXX' },
  { code: 'MY', name: 'Malaysia', dial_code: '+60', placeholder: 'XX-XXXX XXXX' },
  ...
  { code: 'NG', name: 'Nigeria', dial_code: '+234', placeholder: 'XXX XXX XXXX' },
  { code: 'NI', name: 'Nicaragua', dial_code: '+505' },
  { code: 'NL', name: 'Netherlands', dial_code: '+31', placeholder: 'X XX XX XX XX' },
  { code: 'NO', name: 'Norway', dial_code: '+47', placeholder: 'XXX XX XXX' },
  { code: 'NP', name: 'Nepal', dial_code: '+977' },
  { code: 'NR', name: 'Nauru', dial_code: '+674' },
  { code: 'NU', name: 'Niue', dial_code: '+683' },
  { code: 'NZ', name: 'New Zealand', dial_code: '+64', placeholder: 'XX XXX XXXX' },
  { code: 'OM', name: 'Oman', dial_code: '+968' },
  { code: 'PA', name: 'Panama', dial_code: '+507' },
  { code: 'PE', name: 'Peru', dial_code: '+51', placeholder: 'XXX XXX XXX' },
  { code: 'PF', name: 'French Polynesia', dial_code: '+689' },
  { code: 'PG', name: 'Papua New Guinea', dial_code: '+675' },
  { code: 'PH', name: 'Philippines', dial_code: '+63', placeholder: 'XXX XXX XXXX' },
  { code: 'PK', name: 'Pakistan', dial_code: '+92', placeholder: 'XXX XXXXXXX' },
  { code: 'PL', name: 'Poland', dial_code: '+48', placeholder: 'XXX XXX XXX' },
  { code: 'PM', name: 'Saint Pierre and Miquelon', dial_code: '+508' },
  { code: 'PN', name: 'Pitcairn', dial_code: '+64' },
  { code: 'PR', name: 'Puerto Rico', dial_code: '+1', placeholder: '(XXX) XXX-XXXX' },
  { code: 'PS', name: 'Palestine', dial_code: '+970' },
  { code: 'PT', name: 'Portugal', dial_code: '+351', placeholder: 'XXX XXX XXX' },
  ...
  { code: 'RO', name: 'Romania', dial_code: '+40', placeholder: 'XXX XXX XXX' },
  { code: 'RS', name: 'Serbia', dial_code: '+381' },
  { code: 'RU', name: 'Russian Federation', dial_code: '+7', placeholder: 'XXX XXX-XX-XX' },
  { code: 'RW', name: 'Rwanda', dial_code: '+250' },
  { code: 'SA', name: 'Saudi Arabia', dial_code: '+966', placeholder: 'XX XXX XXXX' },
  { code: 'SB', name: 'Solomon Islands', dial_code: '+677' },
  { code: 'SC', name: 'Seychelles', dial_code: '+248' },
  { code: 'SD', name: 'Sudan', dial_code: '+249' },
  { code: 'SE', name: 'Sweden', dial_code: '+46', placeholder: 'XX-XXX XX XX' },
  { code: 'SG', name: 'Singapore', dial_code: '+65', placeholder: 'XXXX XXXX' },
  ...
  { code: 'TH', name: 'Thailand', dial_code: '+66', placeholder: 'XX XXX XXXX' },
  ...
  { code: 'TR', name: 'Turkiye', dial_code: '+90', placeholder: 'XXX XXX XX XX' },
  { code: 'TT', name: 'Trinidad and Tobago', dial_code: '+1' },
  { code: 'TV', name: 'Tuvalu', dial_code: '+688' },
  { code: 'TW', name: 'Taiwan', dial_code: '+886', placeholder: 'XXX XXX XXX' },
  { code: 'TZ', name: 'Tanzania', dial_code: '+255' },
  { code: 'UA', name: 'Ukraine', dial_code: '+380', placeholder: 'XX XXX XX XX' },
  { code: 'UG', name: 'Uganda', dial_code: '+256' },
  { code: 'UM', name: 'United States Minor Outlying Islands', dial_code: '+1' },
  { code: 'US', name: 'United States', dial_code: '+1', placeholder: '(XXX) XXX-XXXX' },
  ...
  { code: 'VG', name: 'Virgin Islands, British', dial_code: '+1' },
  { code: 'VI', name: 'Virgin Islands, U.S.', dial_code: '+1' },
  { code: 'VN', name: 'Viet Nam', dial_code: '+84', placeholder: 'XX XXXX XXXX' },
  ...
  { code: 'ZA', name: 'South Africa', dial_code: '+27', placeholder: 'XX XXX XXXX' },
